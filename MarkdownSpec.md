...
У заголовков есть уровент в зависимости от числа хештегов.
...
# Regex
спросить про двойное подчеркивание, про кейс с цифрами поподробнее
_(хотя бы одна буква)пробел(опц)(буква опц)_ (внутри повторяется)
или
_(хотя бы одна буква)_буква (внутри повторяется)
или
буква_(хотя бы одна буква)_буква (внутри повторяется)
или
буква_(хотя бы одна буква)_ (внутри повторяется)
